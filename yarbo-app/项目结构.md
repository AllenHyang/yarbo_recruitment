...
本文档详细说明了 Yarbo 招聘系统的完整文件结构，包括新开发的批量操作、数据导出和智能面试调度功能。
...
| 类型          | 数量 | 说明                                                   |
| ------------- | ---- | ------------------------------------------------------ |
| 新增 API 文件 | 5 个 | 批量操作、数据导出、智能调度、申请提交自动注册相关 API |
| 新增组件文件  | 3 个 | 批量操作工具栏、数据导出、智能调度组件                 |
| 新增工具文件  | 2 个 | 导出工具函数、智能调度算法                             |
| 新增页面文件  | 4 个 | 候选人选择页面、两个测试页面、申请提交测试页面         |
| 更新页面文件  | 4 个 | 申请管理、候选人管理、面试管理、申请表单页面           |
| 文档文件      | 5 个 | README、功能文档、开发总结等                           |
